...
export const GAMES: GameInfo[] = [
  // Ivós játékok
  {
    ...
    rules:
      "Húzz egy kártyát a körből! Minden lapnak megvan a szabálya. Aki a 4. Királyt húzza, megissza a poharat a közepén!",
    rulesEn:
      "Draw a card from the circle! Each card has a rule. Whoever draws the 4th King drinks the cup in the middle!",
    category: "drinking",
    minPlayers: 2,
    maxPlayers: 10,
    duration: "20-40 perc",
  ...
  },
  {
    ...
    rules:
      "4 kör kérdés minden játékosnak: piros/fekete, magasabb/alacsonyabb, között/kívül, van-e ilyen szín. A végén a legtöbb lappal rendelkező buszozik!",
    rulesEn:
      "4 rounds of questions: red/black, higher/lower, inside/outside, suit guess. Most cards at the end rides the bus!",
    category: "drinking",
    minPlayers: 2,
    maxPlayers: 8,
    duration: "15-30 perc",
  ...
  },
  {
    ...
    rules:
      "Közelíts 21-hez anélkül, hogy túllépnéd! Ha vesztesz, iszol annyi kortyot amennyi a tét volt. Ha nyersz, te osztod ki!",
    rulesEn:
      "Get close to 21 without going over! Losers drink the bet amount, winners give out sips!",
    category: "drinking",
    minPlayers: 2,
    maxPlayers: 6,
    duration: "20-45 perc",
  ...
  // Nem ivós (party) játékok
  {
    ...
    rules:
      "Tartsd a telefont a homlokodhoz! A többiek leírják a megjelenő szót, te pedig kitalálod. Helyes válaszért kortyot osztasz, rosszért iszol!",
    rulesEn:
      "Hold the phone to your forehead! Others describe the word, you guess. Correct = give sips, wrong = drink!",
  ...
  },
  {
    ...
    rules:
      "Válassz egy szót a kártyáról és írd körül CSAK egyszótagú szavakkal! Tilos: a szó kimondása, mutogatás, hangutánzó szavak, betűzés.",
    rulesEn:
      "Pick a word from the card and describe it using ONLY one-syllable words! Forbidden: saying the word, gesturing, onomatopoeia, spelling.",
    category: "non-drinking",
    minPlayers: 4,
    maxPlayers: 10,
    duration: "20-40 perc",
  ...
  },
  {
    ...
    rules:
      'Egy játékos kap leírást (pl. "kellemes feneket törölni vele"). A többiek számot kapnak 1-10 és mondanak dolgokat. A tippelő kitalálja a sorrendet!',
    rulesEn:
      "One player gets a description. Others get numbers 1-10 and name things. Guesser figures out the order!",
    category: "non-drinking",
    minPlayers: 4,
    maxPlayers: 10,
    duration: "20-30 perc",
